...
export default function DetailPage() {
  ...
  // Проверка валидности координат (массив из 2 чисел)
  const isValidCoords = (c) => Array.isArray(c) && c.length === 2 && typeof c[0] === 'number' && typeof c[1] === 'number';
    ...
    <div className={`detail-layout ${mapOpen ? 'map-open' : ''}`}>
      ...
      <div className="news-container">
        ...
        <div className="nav-buttons">
          ...
          <Link to="/" className="nav-site-logo">MapsNews</Link>
        </div>
